...
#carousel > div.search-container > div > div > div > form > input.btn.btn-default.search-name-btn{
color:black;
            ...
            <main id='main'>
                                        ...
                                        <form class="form-inline" action="/searchFromMain.camp" accept-charset="UTF-8"
                                            ...
                                            <div class='input-check-in-out input-check-in-out__two_days'>
                                                <div class='datepicker-check_in'>
                                                    <input type="text" name="check_in" id="check_in" value="2021/12/23"
                                                        class="dateinput" readonly="readonly" />
                                                </div>
                                                <div class='datepicker-check_out'>
                                                    <input type="text" name="check_out" id="check_out"
                                                        value="2021/12/24" class="dateinput" readonly="readonly" />
                                                </div>
                                            </div>
                ...
                <section class='section-notice'>
                    <div class='container'>
                        ...
                        <h5 class='section-subtitle'>떼캠 소식에서 공지사항과 캠핑과 관련된 이슈들을 확인하세요.</h5>
                        <div class='row'>
                            <div class='col-xs-8'>
                                <ul class='thumb-list row main-cast--swiper swiper-container '>
                                    <img src = "/resources/img/withcorona.png";>
