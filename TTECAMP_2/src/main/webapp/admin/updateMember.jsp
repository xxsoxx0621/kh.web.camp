	...
	<div class="container">
		<c:forEach var="dto" items="${list }">
			<form action="/updateInfoProc.mypage" method="post"
				...
				<div class='txtb'>
					아이디 <input type="text" value="${dto.user_id}" id="id" name="id">
				</div>
				<div class='txtb'>
					이름 <input type="text" value="${dto.name}" id="name" name="name">
				</div>

				<div class='txtb'>
					변경할 비밀번호 <input type="text" id="changePw" name="changePw">
					<input type="text" id="presentPw" name="presentPw"
						value="${dto.password}" hidden>

				</div>
				<div class='txtb'>
					변경할 비밀번호 재입력 <input type="password" id="changeRePw"
						name="changeRePw"> <span id="checkPw"></span>
					<script>
				...
				<div class='txtb'>
					전화번호 <input type="text" value="${dto.phone}" id="hiddenPhone"
						hidden name="phone1"> <select name="phone1" id="phone1">
						<option value="02">02
				...
				<div class='txtb'>
					우편번호 <input type="text" value="${dto.zip_code}"
						id="sample6_postcode" name="zipcode"> <input
						type="button" value="주소검색" id="searchAdd"
						onclick="sample6_execDaumPostcode()">
				</div>
				<div class='txtb'>
					주소 <input type="text" value="${dto.address1}" name="address1"
						id="sample6_address" disabled>
				</div>
				<div class='txtb'>
					상세주소 <input type="text" value="${dto.address2}" name="address2"
						id="sample6_detailAddress">
				</div>
				<div class='txtb'>
					비밀번호찾기질문 <input type="text" value="${dto.hint}" id="getHint" hidden>
				...
				<div class='txtb'>
					비밀번호찾기답변 <input type="text" value="${dto.hint_answer}"
						name="hintAnswer" id="hintAnswer">
				</div>
