...
public class ReservationDTO {
	...
	public ReservationDTO(String reservation_id, String user_id, String contentId, String client_name,
			String people_num, String contact, String refund_bank_code, String account_num, String car_num,
			Date reservation_made_date, String is_paid, String is_booked) {
		super();
