...
public class APIDAO {
	...
	public static List<JSONObject> getAPIData() {
		...
		try {
			URL url = new URL(
					"http://api.visitkorea.or.kr/openapi/service/rest/GoCamping/basedList?serviceKey=6tyTSMNSNVWydCEqSdLgKCZOwAaVULvXG%2FwiR1ou%2BIaliHgkSPkX%2Br1X1rVAArPMfaMQWttJKrraESeKuCA2%2BQ%3D%3D&pageNo=1&numOfRows=50&MobileOS=ETC&MobileApp=AppTest&_type=json");
