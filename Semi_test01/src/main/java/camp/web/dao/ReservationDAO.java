...
public class ReservationDAO {
	...
	public int insertReservation(ReservationDTO dto) throws Exception {
		...
		try (Connection con = this.getConnection(); PreparedStatement pstat = con.prepareStatement(sql);) {
			...
			pstat.setString(4, dto.getClient_name());
			pstat.setString(5, dto.getPeople_num());
			pstat.setString(6, dto.getContact());
			pstat.setString(7, dto.getRefund_bank_code());
			pstat.setString(8, dto.getAccount_num());
			pstat.setString(9, dto.getCar_num());		
