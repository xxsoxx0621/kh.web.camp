...
<body>
	...
	<div id="container">
		<div id="top">자유게시판 글 작성하기</div>


		<div id="input_title">

			<form action="/completeQnaWrite.qna">
				<input type="text" class="titleBlank " name="input_title" id="title"
					value="글 제목을 입력하세요.">
		</div>
		<div id="content">
			<textarea name="content" class="textarea" id="content_text" cols="30"
				rows="10">글 내용을 입력하세요.</textarea>
		</div>
		<div id="bottoms">
			<input type="submit" value="작성하기">
			</form>
			<a href="/qna/qnaList.jsp"><button type="button">목록으로</button></a>
		</div>
	</div>
