...
<body>
	...
	if (cookies != null && cookies.length > 0) // 쿠기값이 있거나, 쿠키값이 0 보다 클 때,
		for (int i = 0; i < cookies.length; i++) {
			if (cookies[i].getName().equals("id")) { // id 값 찾아서 쿠기저장
	...
	<form action="/loginProc.mem" method="post" id="loginForm">
		<div class="Login_Form">
			...
			<div class="chkbox" name="checkbox" id="saveLogin">
				<span><input type="checkbox"></span><span> 아이디 기억하기</span> 
			</div>
			<input type='button' class='loginbt btn' value='Login' id="login">
