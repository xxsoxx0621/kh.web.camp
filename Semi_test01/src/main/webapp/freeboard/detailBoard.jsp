...
<body>
	...
	<div id="container">
		...
		<div id="comment_container">
			<div id="comment_info">
				<div id="comment_id">유저</div>
				<div id="comment_content">댓글</div>
	...
	<div id="bottoms">
		...
		<c:choose>
			<c:when test="${detail.user_id == loginID}">
		...
		<a href="/boardlist.board?cpage=1"><button type="button">목록으로</button></a>
	</div>
	</div>
