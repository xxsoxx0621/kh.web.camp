		...
		<section class="section-list campground-show">
            ...
            <div class="map-thumb" id="btn-map" style="background-image: url(/rails/active_storage/representations/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBGQT09IiwiZXhwIjpudWxsLCJwdXIiOiJibG9iX2lkIn19--e6d8b8f63cb0540d1576d8dadbaa327e5529529b/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaDdCam9VY21WemFYcGxYM1J2WDJ4cGJXbDBXd2RwQXBJRWFRTFFCdz09IiwiZXhwIjpudWxsLCJwdXIiOiJ2YXJpYXRpb24ifX0=--3dca9d2db46a9778f1ca04ac37b13f43169f43d5/%E1%84%87%E1%85%A2%E1%84%8E%E1%85%B5%E1%84%83%E1%85%A9.png )">
				...
				<div class="info-wrapper">
					<h1>
						<img src="/resources/img/mapicon.png"
							style="width: 50px; height: 50px;" /> ${dto.facltNm}
						<div class='like-btn need_login' data-url='/campgrounds/1769/toggle_like'>
					...
					<h6>
						...
						<a target="_blank" href="https://munsugolcamping.com/"><a
							href="${dto.homepage}" id="homepage">${dto.homepage}</a></a>
					</h6>
			...
			<div class="container">
				...
				<div class="tab-wrapper">
					...
					<ul class="nav nav-tabs camp-tabs" id="camp-tab" role="tablist">
						<li class="active li-3" role="presentation"><a
							aria-controls="info" data-toggle="tab" href="#info" role="tab">캠핑장
								소개</a></li>

						<li class="li-3" role="presentation"><a
							aria-controls="select-area" data-toggle="tab" href="#select-area"
							role="tab">예약하기</a></li>

						<li class="li-3" role="presentation"><a
							aria-controls="review" data-toggle="tab" href="#review"
							role="tab">이용후기</a></li>
					</ul>
								...
								<div class="text-area">
									<p style="text-align: center; line-height: 1;">
										<b><span style="font-size: 24px;"><b>캠핑장 이용수칙을
													<font color="#ff0000">반드시 확인</font>하시어 <font
													color="#ff0000">불이익을 받지 않으시도록 꼭 확인</font> 부탁드립니다.<br>
												<span style="font-size: 18px;"><font color="#3984c6">환불
															시 계좌이체 수수료 1,000원을 차감 후 환불</font>됨을 다시 한번 알려드립니다.</span><br>
											</b></span></b>
									</p>
									<p style="text-align: center; line-height: 1;">
									...
									<p style="text-align: center; line-height: 1;">
										<span style="font-size: 24px;"><b style=""><font
												color="#ff0000">긴급공지</font><br>
											<br>
											<font color="#424242">현재 </font><font color="#ff0000">호숫가존
													앞에 있는 저수지</font><font color="#424242">가 </font><font
												color="#ff0000"
												style="background-color: rgb(255, 255, 255);">공사중이라
													물이 빠진 상황</font><font color="#424242">입니다.<br>이점
											</font><font color="#ff0000"
												style="background-color: rgb(255, 255, 255);">반드시
													확인하시고 캠핑장 이용에 참고</font><font color="#424242">하시길 부탁드립니다.</font></b></span>
									</p>
									<p style="text-align: center; line-height: 1;">
										<br>
									</p>
									<p style="text-align: center; line-height: 1;">
										<b style="font-size: 24px;"><span
											style="font-size: 20px; background-color: rgb(255, 255, 255);">${dto.facltNm}
												 <font color="#ff0000">체크아웃 기준 +31일까지만 예약이 가능</font>합니다.
										</span></b>
									</p>
									<p style="text-align: center; line-height: 1;">
										<b style="font-size: 24px;"><span style="font-size: 20px;"><font
												color="#ff0000">불공정한 방법</font>을 통해<font color="#ff0000">
								...
								<c:if test="${dto.animalCmgCl ne '불가능'}">
									...
									<p style="text-align: center; line-height: 1;">
										<b style="font-size: 24px;">애견 동반<font color="#ff0000">&nbsp;불가능<br>
											<br></font></b><b style="font-size: 24px;"><span
											style="font-size: 20px;">${dto.facltNm} 힐링캠핑장은 
												구역 애견 동반이 불가능합니다.</b>
									</p>
									</c:if>
									...
									<p>
										<b><font face="Arial"><span lang="EN-US"
												...
												style="letter-spacing: 0pt; font-size: 16px;">&gt;</span></font></b>
									</p>
									<p>
									...
									<p>
										<font face="Arial"><span style="font-size: 16px;">문수골
												힐링캠핑장은 수십 그루의 고목들이 제공하는 그늘과 아름다운 풍경 속에서 도심 속의 삶에 지친 여러분들에게
									...
									<p>
										<font face="Arial"><span lang="EN-US"
											style="letter-spacing: 0pt; font-size: 16px;">1.&nbsp;</span><span
											style="font-size: 16px;">식료품 및 장작&nbsp;</span><span
											lang="EN-US" style="letter-spacing: 0pt; font-size: 16px;">(</span><span
									...
									<p>
										<font face="Arial"><span lang="EN-US"
											style="letter-spacing: 0pt; font-size: 16px;">2.&nbsp;</span><span
											style="font-size: 16px;">산장 식사 메뉴&nbsp;</span><span
											lang="EN-US" style="letter-spacing: 0pt; font-size: 16px;">(</span><span
									...
									<p>
										<font face="Arial"><span style="font-size: 16px;">힐링
											...
											style="letter-spacing: 0pt; font-size: 16px;">4</span><span
											style="font-size: 16px;">동(1~4번 사이트)이 설치 되어있고</span><span
											lang="EN-US" style="letter-spacing: 0pt; font-size: 16px;">,&nbsp;</span><span
									...
									<p>
										<span lang="EN-US"
											style="letter-spacing: 0pt; font-size: 16px;"><font
											face="Arial">힐링 B존의 3, 4번 사이트는 진입로가 협소하여 되도록이면 대단위
									...
									<p>
										<font face="Arial"><span style="font-size: 16px;">시냇가
											...
											style="font-size: 16px;">만원을 추가 결제해주시면 됩니다</span><span
											lang="EN-US" style="letter-spacing: 0pt; font-size: 16px;">.</span></font>
									</p>
									<p>
										<br>
									...
									<p>
										<font face="Arial"><span style="font-size: 16px;">5
												...
												&nbsp; 반드시 이점 유의하시기 바라며&nbsp;<b>${dto.facltNm}에서는 열매, 꽃등으로 인한
									...
									<p>
										<span lang="EN-US"
											style="letter-spacing: 0pt; font-size: 16px;"><b><font
												face="Arial"></font></b></span>
									</p>
									<p>
										<font face="Arial"><span lang="EN-US"
											style="letter-spacing: 0pt; font-size: 16px;">2.&nbsp;</span><span
								...
								<ul class="camping-list">
									...
									<li>
										...
										<div class="body body-long ">
											...
											<a
												href="/campgrounds/1758/areas/21?check_in=2021%2F12%2F16&amp;check_out=2021%2F12%2F18">
									...
									<li>
										...
										<div class="body body-long ">
											...
											<a
												href="/campgrounds/1758/areas/22?check_in=2021%2F12%2F16&amp;check_out=2021%2F12%2F18">
                  ...
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        ...
                        <div class="tab-content">
                           ...
                           <h2 class="modal-title" id="myModalLabel">문수골 힐링캠핑장</h2>
                  ...
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        ...
                        <div class="tab-content">
                           ...
                           <h2 class="modal-title" id="myModalLabel">문수골 힐링캠핑장 배치도</h2>
