...
<link href="/resources/css/index.css" rel="stylesheet">
					...
					<nav class='navbar'>
						<div class='container clearfix text-center'>
							...
							<ul class='navbar-menu list-inline'>
								...
								<li><a href="/questionControl.admin"><button>1:1 문의</button></a></li>
							</ul>
	...
	<div id="main">
						...
						<a href="/showAllRev.admin"><button>예약관리</button></a> 
						<a href="/manageMember.admin?cpage=1"><button>회원관리</button></a> 
