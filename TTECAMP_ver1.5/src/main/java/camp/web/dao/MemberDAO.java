...
public class MemberDAO {
	...
	// 관리자
		public int adminUpdateInfo(MemberDTO dto) throws Exception{
			
			// 변경될 비밀번호가 없을 때,
			String sql = "update member set password =? ,name =?,  email =?, phone =?, originEmail = ? ,zip_code =?, address1 =?, address2 =?, hint =?, hint_answer =? where user_id = ?";
			...
			try(Connection con = this.getConnection();
				...
				pstat.setString(3, dto.getEmail());
				pstat.setString(4, dto.getPhone());
				pstat.setString(5, dto.getOriginEmail());
				pstat.setString(6, dto.getZip_code());
				pstat.setString(7, dto.getAddress1());
				pstat.setString(8, dto.getAddress2());
				pstat.setString(9, dto.getHint());
				pstat.setString(10, dto.getHint_answer());
				pstat.setString(11, dto.getUser_id());
		...
		public int adminUpdateInfo1(MemberDTO dto) throws Exception{
		
			// 변경될 비밀번호가 있을 때,
			String sql = "update member set password = ?, name =? ,phone =?,email =?, originEmail = ?,zip_code =?, address1 =?, address2 =?, hint =?, hint_answer =? where user_id = ?";
